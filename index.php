...
<html>
<head>
<title>Login dengan cookie dan session</title>
<link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
</head>
<body id="LoginForm">
<div class="container">
<h1 class="form-heading">Cookie dan Session</h1>
    ...
    <div class="main-div">
        ...
        <form id="Login" method="POST" action="login.php">
            ...
            <div class="form-group" style="text-align:left;">
                <label><input type="checkbox" name="ingat" <?php if (isset($_COOKIE["user"]) && isset($_COOKIE["pass"])){ echo "checked";}?>> tetap ingat aku </label>
            </div>
            <div class="lupa">
        ...
        <p class="botto-text"> RifkyImamP</p>
    </div>
</div>
<style>
